    ...
    useEffect(() => {
        async function fetchData() {
            ...
            try {
                ...
                // Fetch villages
                const villageRes = await fetch(`/api/villages?ampurcode=${id}&year=${year}`);
                                                                                    ...
                                                                                    {year !== 2567 && (
                                                                                        <>
                                                                                            ...
                                                                                            <div className="flex flex-col items-end">
                                                                                                ...
                                                                                                <span className="text-purple-600 font-bold text-sm">{new Intl.NumberFormat('th-TH').format(v.households || 0)}</span>
                                                                                            </div>
                                                                                        </>
                                                                                    )}
                                                                                </div>
                                        ...
                                        <tr className="border-t font-bold text-gray-800">
                                            ...
                                            {year !== 2567 && (
                                                <td className="py-4 pr-4 text-right">
                                                    {new Intl.NumberFormat('th-TH').format(districtTotal.households)}
                                                </td>
                                            )}
                                        </tr>
                                    </>
