    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="text-[14px] font-bold uppercase tracking-[0.2em]">{label}</span>
            ...
            {subTitle && (
                <p className="text-[11px] text-slate-300 font-medium tracking-wider text-center max-w-[300px]">
                    {subTitle}
                </p>
            )}
        </motion.div>
